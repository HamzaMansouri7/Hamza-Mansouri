...
export class ProfileService {
  ...
  about2 = `Frontend Developer with 3 + years of experience .
  Worked with Frontend Development Life Cycle(SDLC) and  agile methodologies .
  Expertise in Angular 2.5 + All versions, React, Javascript,  Node JS and UI with Responsive Designs .
  Have good understanding of Nestjs, loopback , Jquery, Bootstrap, MongoDB, Firebase, and MYSQL`
  ...
  exprienceData: any = [
    {
      ...
      timeline: 'From April 2017 to July 2017',
      role: 'Android Developer - Internship',
      work: 'Working as a Android Developer'
    },
    {
      id: 4,
  ...
  extraCircularInfo: any = [
    {
      ...
      title: 'Linked-in',
      description: '',
      img: 'assets/images/hamza_linkedin.png',
      url: 'https://www.linkedin.com/in/mansouri-hamza-3ab7aa160/'
    },
    {
      id:1,
      title: 'Github',
      description: '',
      img: 'assets/images/hamza_github.png',
      url: 'https://github.com/HamzaMansouri7'
    },
    {
      id:1,
      title: 'Freelancing',
      description: '',
      img: 'assets/images/hamza_freelancing.png',
      url: 'https://www.upwork.com/freelancers/~0128eeed4e008a1d1d'
    },
